...
const Resume = (props) => {
  ...
  const resumeDetails = [
    <div className="resume-screen-container" key="education">
      <ResumeHeading
        heading={"University of Skovoroda G.S.,Ukraine ,Kharkiv"}
      ...
      <ResumeHeading
        heading={"Gamma Intl."}
        subHeading={"Front end courses"}
        fromDate={"2022"}
        toDate={"present"}
      />
      <ResumeHeading
        heading={"High School "}
        subHeading={"Ukraine,Kharkiv"}
        fromDate={"2004"}
        toDate={"2006"}
      />
    </div>,
    ...
    <div className="resume-screen-container" key="interests">
      ...
      <ResumeHeading
        heading="Music"
        description="Listening to music is something i can never com can get my hands on."
      />
      <ResumeHeading
